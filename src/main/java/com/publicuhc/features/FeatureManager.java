...
public interface FeatureManager {
     ...
     * @throws com.publicuhc.features.exceptions.FeatureIDConflictException when feature with the same ID already exists
     * @throws com.publicuhc.features.exceptions.InvalidFeatureIDException  when the feature has an invalid ID name
     */
     ...
     * @throws com.publicuhc.features.exceptions.FeatureIDNotFoundException when feature not found
     */
